...
// credit: https://www.youtube.com/watch?v=6MGUNBum2jo
//         https://www.youtube.com/watch?v=cWWjbVPhh0k
            ...
            public void onStyleLoaded(@NonNull Style style) {
                ...
                addOnMapClickListener(mapView.getMapboxMap(), new OnMapClickListener() {
                    ...
                    public boolean onMapClick(@NonNull Point point) {
                        for (PointAnnotation annotation : userAnnotations) {
                            pointAnnotationManager.delete(annotation);
                        }
                        Bitmap bitmap = BitmapFactory.decodeResource(getResources(), R.drawable.location);
                        PointAnnotationOptions pointAnnotationOptions = new PointAnnotationOptions().withTextAnchor(TextAnchor.CENTER).withIconImage(bitmap)
                                .withPoint(point);
                        PointAnnotation userAnnotation = pointAnnotationManager.create(pointAnnotationOptions);
    ...
    private void fetchRoute(Point point) {
        ...
        locationEngine.getLastLocation(new LocationEngineCallback<LocationEngineResult>() {
            ...
            public void onSuccess(LocationEngineResult result) {
                ...
                builder.continueStraight(false);
